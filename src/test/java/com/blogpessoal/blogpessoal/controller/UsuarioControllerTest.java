...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		 ...
		 */
		HttpEntity<UsuarioModel> corpoRequisicao = new HttpEntity<UsuarioModel>(new UsuarioModel(0L,"Paulo Antunes","paulo_antunes@email.com.br", "123456789", "https://i.imgur.com/JR7kUFU.jpg"));
		/**
	...
	public void naoDeveDuplicarUsuario() {
		 ...
		 */
		usuarioService.CadastrarUsuario(new UsuarioModel(0L, "Maria da Silva", "maria_silva@email.com.br","123456789","https://i.imgur.com/T12NIp9.jpg"));
		 ...
		 */
		HttpEntity<UsuarioModel> corpoRequisicao = new HttpEntity<UsuarioModel>(new UsuarioModel (0L, "Maria da Silva", "maria_silva@email.com.br","123456789","https://i.imgur.com/T12NIp9.jpg"));
	...
	public void deveAtualizarUmUsuario() {
		 ...
		 */
		Optional<UsuarioModel> usuarioCadastrado = usuarioService.CadastrarUsuario(new UsuarioModel(0L, "Carla da Silva","carla_silva@email.com.br","123456789","https://i.imgur.com/T12NIp9.jpg"));
		 ...
		 */
		UsuarioModel usuarioUpdate = new UsuarioModel(usuarioCadastrado.get().getId(),"Carla Silva","carla_silva@email.com.br","123456789","https://i.imgur.com/T12NIp9.jpg");
	...
	public void deveMostrarTodosUsuarios() {
		 ...
		 */
		usuarioService.CadastrarUsuario(new UsuarioModel(0L, "Maria da Silva", "maria_silva@email.com.br","123456789","https://i.imgur.com/T12NIp9.jpg"));
		usuarioService.CadastrarUsuario(new UsuarioModel(1L, "Joao Carlos", "joaocarlos@email.com.br","123456789","https://i.imgur.com/T12NIp9.jpg"));
	...
	public void deveListarApenasUmUsuario() {
		 ...
		 * de dados, o Optional evitará o erro NullPointerException (Objeto Nulo).
		 */
		Optional<UsuarioModel> usuarioBusca = usuarioService.CadastrarUsuario(new UsuarioModel(0L, "Maria da Silva", "maria_silva@email.com.br","123456789","https://i.imgur.com/T12NIp9.jpg"));
